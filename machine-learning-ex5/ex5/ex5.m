...
% *******Note that even if the lambda is zero, the hypothesis has a very high bias. You can see that in the plot
% *******However in most of the cases you cannot plot and see the bias. You need to infer it with the learning curves.
lambda = 0;
...
ylabel('Water flowing out of the dam (y)');
hold on;
% Note that the discreteness of the training set plot is due to the marker 'x' selected.
% Continuity of the same plot for the hypothesis is continuous because of the marker '-'
